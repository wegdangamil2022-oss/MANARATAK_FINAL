      ...
      <div className="relative rounded-3xl p-3.5 sm:p-4 bg-gradient-to-b from-[var(--mn-surface)] to-[var(--mn-page)]/80 border border-[var(--mn-border)] shadow-sm border-t-2 border-t-[var(--mn-accent)]/40 overflow-hidden mn-panel ">
        <div className="relative z-10">
          <div className="text-center mb-3.5">
            <h3 className="text-sm sm:text-base font-black text-[var(--mn-heading)] inline-flex items-center justify-center gap-1.5 font-['Cairo',sans-serif]">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3 w-full">
            {PREVIEW_TOOLS.map((tool) => (
              ...
              >
                ...
                <h4 className="mt-2 text-[11px] sm:text-xs font-black text-[var(--mn-heading)] leading-snug font-['Cairo',sans-serif]">
                  {tool.title}
                </h4>
