      ...
      <div className="p-3.5 sm:p-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0">
                <h3 className="text-[15px] sm:text-base font-black text-[var(--mn-heading)] font-['Cairo',sans-serif] leading-6">{title}</h3>
                <p className="text-[10px] sm:text-[11px] font-extrabold text-[var(--mn-heading)] mt-0.5">{eyebrow}</p>
              </div>
              <span className="px-2 py-1 rounded-full bg-[var(--mn-accent)]/10 border border-[var(--mn-accent)]/20 text-[9px] font-black text-[var(--mn-accent-text)] whitespace-nowrap">{badge}</span>
            </div>
        ...
        <div className="grid grid-cols-3 gap-1.5 mt-3">
          {features.map(({ label, icon: FeatureIcon }) => (
            <span key={label} className="min-h-8 rounded-xl bg-[var(--mn-page)] border border-[var(--mn-border)] px-1.5 flex items-center justify-center gap-1 text-[9px] font-extrabold text-[var(--mn-text-muted)] mn-panel ">
        ...
        <div className="mt-3 pt-2.5 border-t border-[var(--mn-border)] flex items-center justify-between gap-2">
          ...
          <span className="inline-flex items-center gap-1.5 text-[11px] font-black text-[var(--mn-heading)] whitespace-nowrap">
            {cta}
...
export const CoursesLandingPage: React.FC<CoursesLandingPageProps> = ({ onBack, onOpenTrack }) => {
  return (
    ...
    >
      ...
      {/* ========================================================================= */}
      <div className="max-w-md sm:max-w-xl mx-auto px-3.5 sm:px-4 -mt-5 relative z-20 pb-24">
        <div className="bg-[var(--mn-surface)] rounded-[22px] border border-[var(--mn-border)] shadow-lg px-3.5 py-3.5 mb-3.5 mn-panel ">
          <div className="flex items-center justify-between gap-3">
            <div className="text-right min-w-0">
              <h2 className="text-[15px] sm:text-base font-black text-[var(--mn-heading)] font-['Cairo',sans-serif]">اختر نوع الدورات</h2>
