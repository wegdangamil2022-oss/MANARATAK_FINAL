              ...
              <div className="flex gap-4 sm:gap-6 items-start">
                {EXAMS_LIST.map((exam, idx) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] sm:text-xs font-bold text-slate-700 text-center uppercase tracking-wider group-hover:text-[#064D83] transition-colors line-clamp-1">
                      {exam.name}
                    </span>
                  </div>
                ))}
