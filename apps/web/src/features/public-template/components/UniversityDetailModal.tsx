...
export const UniversityDetailModal: React.FC<UniversityDetailModalProps> = ({
  ...
  return (
    <div
      className="w-full bg-slate-50 dark:bg-[#031322] animate-fade-in font-['Cairo',sans-serif] min-h-screen"
      dir="rtl"
    >
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="flex flex-col pt-0.5">
                <h1 className="text-xl sm:text-2xl font-black text-white leading-tight drop-shadow-sm flex items-baseline gap-2 flex-wrap">
                  ...
                  <span className="text-sm sm:text-base text-[#D9A93A] font-bold opacity-90">
          ...
          {university.websiteUrl ? (
            <div className="w-full flex justify-center mt-1">
              <a
                ...
                className="w-full sm:w-2/3 bg-[#FAFAFA] hover:bg-slate-50 text-[#064D83] rounded-lg py-2 flex items-center justify-center gap-2 font-black text-[11px] sm:text-xs transition-colors shadow-sm border border-[#064D83]/20"
              >
      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 pt-6 pb-24 flex flex-col gap-6">
        ...
        <section>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] leading-tight font-['Cairo',sans-serif]">
              نبذة عن الجامعة
            </h2>
          </div>

          <div className="bg-[#FAFAFA] rounded-2xl p-4 sm:p-5 border border-slate-100 shadow-sm relative overflow-hidden">
            {/* زخرفة خلفية ناعمة */}
        ...
        {university.rankings && university.rankings.length > 0 && (
          <div
            className="relative -mx-4 sm:-mx-6 bg-[#FAFAFA] dark:bg-[#041628] border-y border-[#064D83]/30 dark:border-[#153C63] shadow-md shadow-slate-200/50 dark:shadow-none overflow-hidden"
            dir="rtl"
          >
            ...
            <div className="p-4 sm:p-5 space-y-2.5 font-['Cairo',sans-serif]">
              {university.rankings.map((ranking, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="bg-[#FAFAFA] dark:bg-[#0A2A48] rounded-2xl border border-[#F2E8D5] dark:border-[#1A456E] hover:border-[#064D83] dark:hover:border-[#D9A93A] p-3 sm:p-3.5 shadow-2xs hover:shadow-xs transition-all flex items-center justify-between gap-2.5 relative overflow-hidden group"
                  >
        ...
        {university.studyPrograms && (
          ...
          >
            ...
            <div className="p-4 sm:p-5 space-y-4 font-['Cairo',sans-serif]">
              ...
              <div className="p-3.5 sm:p-4 rounded-2xl bg-gradient-to-br from-slate-50/90 dark:from-[#072440] via-white dark:via-[#082848] to-amber-50/20 dark:to-[#072440] border border-[#F2E8D5] dark:border-[#1A456E] space-y-2.5 shadow-2xs">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-lg bg-[#064D83]/10 dark:bg-[#D9A93A]/20 text-[#064D83] dark:text-[#D9A93A] flex items-center justify-center shrink-0">
                ...
                <div className="flex flex-wrap items-center gap-2 pt-0.5">
                  <div className="bg-[#FAFAFA] dark:bg-[#0A2E50] border border-[#D9A93A]/40 dark:border-[#D9A93A]/30 text-slate-800 dark:text-slate-100 px-3 py-1.5 rounded-xl text-[11px] sm:text-[11.5px] font-bold flex items-center gap-2 shadow-2xs hover:border-[#064D83] transition-all font-['Cairo',sans-serif]">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#064D83] dark:bg-[#D9A93A] shrink-0" />
                    <span>بكالوريوس</span>
                  </div>
                  <div className="bg-[#FAFAFA] dark:bg-[#0A2E50] border border-[#D9A93A]/40 dark:border-[#D9A93A]/30 text-slate-800 dark:text-slate-100 px-3 py-1.5 rounded-xl text-[11px] sm:text-[11.5px] font-bold flex items-center gap-2 shadow-2xs hover:border-[#064D83] transition-all font-['Cairo',sans-serif]">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#064D83] dark:bg-[#D9A93A] shrink-0" />
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-right pt-0.5">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-start gap-2 p-2.5 rounded-xl bg-[#FAFAFA] dark:bg-[#0A2A48] border border-[#F2E8D5]/80 dark:border-[#1A456E] hover:border-[#D9A93A] hover:bg-slate-50/40 dark:hover:bg-[#0D3358] hover:shadow-2xs transition-all duration-200 group text-right"
                    >
              ...
              <div className="space-y-2 pt-1">
                <div className="flex items-center gap-2 pr-1">
                  <div className="w-6.5 h-6.5 rounded-full bg-[#064D83]/5 dark:bg-[#D9A93A]/10 border border-[#D9A93A]/60 ring-2 ring-[#D9A93A]/20 flex items-center justify-center shrink-0 shadow-2xs">
                    <BookOpen className="w-3.5 h-3.5 text-[#064D83] dark:text-[#D9A93A]" />
                  </div>
                  <span className="text-xs sm:text-[13px] font-black text-[#064D83] dark:text-[#D9A93A] font-['Cairo',sans-serif]">
              ...
              <div className="space-y-2 pt-1">
                ...
                <div className="grid grid-cols-2 gap-2 text-right pt-0.5">
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-[#FAFAFA] dark:bg-[#0A2A48] border border-[#F2E8D5]/80 dark:border-[#1A456E] hover:border-[#D9A93A] transition-all group">
              ...
              <div className="space-y-2 pt-1">
                ...
                <div className="p-3 rounded-xl bg-[#FAFAFA] dark:bg-[#0A2A48] border border-[#F2E8D5]/80 dark:border-[#1A456E] flex items-center gap-3 text-right">
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-2.5 pt-0.5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group bg-[#FAFAFA] dark:bg-[#0A2A48] hover:bg-slate-50/80 dark:hover:bg-[#0D3358] rounded-2xl p-3 border border-[#F2E8D5] dark:border-[#1A456E] hover:border-[#064D83] dark:hover:border-[#D9A93A] shadow-2xs hover:shadow-xs transition-all flex sm:flex-col justify-between sm:justify-center items-center sm:items-start gap-2.5 text-right"
                >
                  <div className="flex items-center sm:w-full justify-between gap-2">
                    <div className="w-8 h-8 rounded-xl bg-blue-50/80 dark:bg-blue-900/30 group-hover:bg-[#064D83] dark:group-hover:bg-[#D9A93A] text-[#064D83] dark:text-blue-300 group-hover:text-white dark:group-hover:text-slate-900 transition-colors flex items-center justify-center shrink-0 shadow-2xs">
                ...
                >
                  <div className="flex items-center sm:w-full justify-between gap-2">
                    <div className="w-8 h-8 rounded-xl bg-amber-50/80 dark:bg-amber-900/30 group-hover:bg-[#D9A93A] text-[#D9A93A] group-hover:text-white dark:group-hover:text-slate-900 transition-colors flex items-center justify-center shrink-0 shadow-2xs">
                ...
                >
                  <div className="flex items-center sm:w-full justify-between gap-2">
                    <div className="w-8 h-8 rounded-xl bg-emerald-50/80 dark:bg-emerald-900/30 group-hover:bg-emerald-600 text-[#064D83] dark:text-[#D9A93A] group-hover:text-white transition-colors flex items-center justify-center shrink-0 shadow-2xs">
        ...
        {university.tuitionFees && (
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center pt-4 pb-3 px-4 bg-gradient-to-b from-slate-50/90 dark:from-[#062038] to-white dark:to-[#041628] border-b border-[#F2E8D5] dark:border-[#153C63]">
              <div className="flex items-center justify-center gap-2 mb-1.5">
                <div className="w-7 h-7 rounded-full bg-[#064D83]/10 dark:bg-[#D9A93A]/15 border border-[#D9A93A]/60 ring-2 ring-[#D9A93A]/20 flex items-center justify-center shrink-0 shadow-2xs">
                  <Landmark className="w-4 h-4 text-[#064D83] dark:text-[#D9A93A]" />
                </div>
                <h2 className="text-xs sm:text-[13px] font-black text-[#064D83] dark:text-[#E4B343] leading-tight font-['Cairo',sans-serif]">
              ...
              <div className="space-y-2 pt-1">
                <div className="flex items-center gap-2 pr-1">
                  <div className="w-6 h-6 rounded-full bg-[#064D83]/5 dark:bg-[#D9A93A]/10 border border-[#D9A93A]/60 ring-2 ring-[#D9A93A]/20 flex items-center justify-center shrink-0 shadow-2xs">
                    <Building2 className="w-3 h-3 text-[#064D83] dark:text-[#D9A93A]" />
                  </div>
                  <span className="text-[11.5px] sm:text-xs font-black text-[#064D83] dark:text-[#D9A93A] leading-tight font-['Cairo',sans-serif]">
                ...
                <div className="flex flex-col gap-2 pt-0.5">
                  ...
                  {university.tuitionFees.undergradTuition && (
                    <div className="bg-[#FAFAFA] dark:bg-[#0A2A48] rounded-xl border border-[#F2E8D5] dark:border-[#1A456E] hover:border-[#064D83] dark:hover:border-[#D9A93A] p-2.5 sm:p-3 shadow-2xs hover:shadow-xs transition-all flex flex-row items-center justify-between gap-3 relative overflow-hidden group">
                      <div className="flex items-center gap-2.5 shrink-0">
                        <div className="w-1.5 h-8 bg-gradient-to-b from-[#064D83] to-[#D9A93A] rounded-full shrink-0" />
                        <span className="text-[11px] sm:text-[11.5px] font-bold text-slate-800 dark:text-slate-100">
                          رسوم البكالوريوس
                        </span>
                      </div>
                      <div className="bg-slate-50 dark:bg-[#062038] border border-slate-200 dark:border-[#1A456E] rounded-lg py-1.5 px-3 flex items-center justify-center text-center shadow-2xs shrink-0 max-w-[55%] group-hover:border-[#064D83]/30 dark:group-hover:border-[#D9A93A]/50 transition-colors">
                        <span className="text-[11px] sm:text-[11.5px] font-black text-[#064D83] dark:text-white">
                          {university.tuitionFees.undergradTuition}
                        </span>
                      </div>
                    </div>
              ...
              {university.tuitionFees.officialTuitionUrl && (
                <div className="pt-1">
                  <a
                    ...
                    className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-[#002E52] via-[#064D83] to-[#002E52] hover:from-[#064D83] hover:to-[#0A5D9E] text-white font-black text-[11px] sm:text-xs flex items-center justify-center gap-2 shadow-sm shadow-[#064D83]/20 hover:shadow-md transition-all active:scale-[0.99] cursor-pointer font-['Cairo',sans-serif]"
                  >
                    <Landmark className="w-3.5 h-3.5 text-[#D9A93A]" />
